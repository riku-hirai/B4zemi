...
def var_array():
    ary_var[0][0] = 0
    ary_var[0][1] = 0
    ary_var[0][2] = copy.copy(ary_0[31][2])
    ary_var[0][3] = copy.copy(ary_0[31][4])
    ary_var[0][4] = copy.copy(ary_0[31][5])
    ary_var[0][5] = copy.copy(ary_0[31][6])
    for  m in range(1,mmax+1):
        ary_var[m][0] = m
        ary_var[m][1] = copy.copy(dt_m[m])
        ary_var[m][2] = copy.copy(ary_m[m][31][2])
        ary_var[m][3] = copy.copy(ary_m[m][31][4])
        ary_var[m][4] = copy.copy(ary_m[m][31][5])
        ary_var[m][5] = copy.copy(ary_m[m][31][6])
